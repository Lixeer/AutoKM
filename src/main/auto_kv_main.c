...
static esp_hid_device_config_t ble_hid_config = {
    ...
    .device_name        = "AutoKV Keyboard Mode",
...
void ble_hid_kbd_task(void *pvParameters)
{
    while (1) {
        send_keyboard('b');
        vTaskDelay(500 / portTICK_PERIOD_MS);
...
static const char *TAG = "auto_kv_main";
void ble_hid_task_start_up(void)
{
    if (s_ble_hid_param.task_hdl) return; 
    xTaskCreate(ble_hid_kbd_task, "ble_hid_kbd_task", 3*1024, NULL, configMAX_PRIORITIES-3, &s_ble_hid_param.task_hdl);
